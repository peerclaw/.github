...
每个 Agent 拥有密码学可验证的 Ed25519 身份、基于真实交互计算的 EWMA 声誉评分、端点验证、以及默认拒绝的 P2P 安全模型（白名单、连接门控、消息验证）。构建在完整的协议网关（A2A、MCP、ACP）之上，并演进为支持 8 种语言的 C2C Agent Marketplace。
...
| [**peerclaw-cli**](https://github.com/peerclaw/peerclaw-cli) | 命令行工具 — 管理 Agent、检查健康、发送消息 |
